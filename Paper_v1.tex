...
However, when there was model mismatch (network B fit against network A data), PSO was not able to identify an ensemble, all else being the same (Fig. \ref{fig-parameter-fit}C and D).
...
Model parameters were estimated by minimizing the difference between simulations and synthetic experimental data using particle swarm optimization \citep{PSO}.
