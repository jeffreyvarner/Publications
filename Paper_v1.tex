...
Although the performance of the proof of principle coagulation model was impressive given its dimension, there are several mathematical and biological questions that can be explored further.
...
range $[0,1]$. Thus, many other function types are possible.
