...
\caption{Metabolic flux and control program output as a function of network type and parameter estimate.
The population of particles from the modified particle swarm optimization strategy were sorted based upon simulation error. 
The scaled metabolic flux and control variables governing the activity of $E_{1},E_{3}$ and $E_{6}$ were plotted for each particle in the swarm.
\textbf{A}: Model performance for the N = 100 positively biased particles.
\textbf{B}: Model performance for the N = 100 uniformly biased particles.
\textbf{C}: Model performance for the N = 100 negatively biased particles.
