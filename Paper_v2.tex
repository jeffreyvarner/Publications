...
\vspace{0.05in}
{\par \centering \large{ Katharine V. Rogers, Joseph A. Wayman, Ryan Tasseff, Caitlin Gee, Timothy Chu, Kyriakos Tsahalis, Spencer Davis, Rohit Yallamraju, Gongcheng Lu, Matthew P. DeLisa, 
...
Cell viability results show a large decrease in cell viability at 72 hrs in the dual inhibition cases as well as the triple inhibition case for both LNCaP and C4-2 cell lines (Fig. \ref{fg:Experiment}B). I
n both cell lines, MDV3100 (10 $\mu$M), has only a modest effect on cell viability versus control (DMSO). 
(Fig. \ref{fg:Experiment}C) shows cell viability of both cell lines in varying concentrations of inhibitors at 24 hrs. 
...
\begin{figure}\centering
\includegraphics[width=1.0\textwidth]{./figs/Fig_6_PI3K_AR_KO_3_Cases_old_new.pdf}
