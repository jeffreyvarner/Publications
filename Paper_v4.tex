...
\begin{algorithm}
\If{$x_{i,j}^{old} < x_{i}^{min}$}{  	
  ${x}_{i,j}^{new}={x}_{i,j}^{old}+(x_{i}^{min} - {x}_{i,j}^{old})$
  \If{${x}_{i,j}^{new}>x_{i}^{max}$}{
    ${x}_{i,j}^{new}=x_{i}^{max}$
  }
}
\If{$x_{i,j}^{old} > x_{i}^{max}$}{  	
  ${x}_{i,j}^{new}={x}_{i,j}^{old}+({x}_{i,j}^{old}-x_{i}^{max})$
  \If{${x}_{i,j}^{new}<x_{i}^{min}$}{
    ${x}_{i,j}^{new}=x_{i}^{min}$
  }
}
\end{algorithm}
...
%Added a little more description here
...
\hline
 ...
 \hline
                        & Experimental Data Set & B1       &B2    & B4   &B5       & Ackley 300D & Rastrigin 300D \\
 \hline
Lower Bound             & 0.001.pnom            & 5.pnom    &10.pnom   & 5.pnom  &varying    & 30          & 5.12           \\
Upper Bound             & 1000.pnom             & 0.2.pnom    &0.1.pnom & 0.2.pnom  &varying  & -15         & -5.12          \\
CPU Time                & 10.0835 hours         & 65.26 hours &17.9 minutes & 6.2 minutes &32.686 minutes& 2.8 seconds & 2.6 seconds    \\
Function Evaluations    & 4000                  & 4000              &4000& 4000        & 4000      &4000  & 4000           \\
Initial Objective Value & 1.11837e+07           & 1.3824e+07 &3.8848e+03  & 1.8536e+07 &1.4288e+04  & 21.12       & 99.985         \\
Final Objective Value   & 90456.9               & 3.5348e+04     &324.4182 & 38.9375    &3.4495e+03  & 0           & 0              \\
Nominal Objective Value & 4.7785e+06            & 1.0986e+06   &- & 39.0676    &4.2737e+03 & 0           & 0      \\
\hline
\end{tabular}
}
\end{table}
